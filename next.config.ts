...
const authorityLinks = [
  ...
  `<${SITE_URL}/freshness.json>; rel=\"describedby\"; type=\"application/json\"`,
...
const nextConfig: NextConfig = {
  ...
  async headers() {
    return [
      ...
      { source: "/research/volponi-ai-index/2026-08.csl.json", headers: immutableResearchHeaders },
      ...
      { source: "/freshness.json", headers: machineOnlyHeaders },
