...
import { SHARE_TEXT, SHARE_URL, strategies } from "@/lib/content";
...
const deepDives = [
  {
    ...
    desc: "Disponibilidade, lançamento, planos elegíveis e o que muda para o mercado brasileiro.",
  },
  {
    href: "/chatgpt-ads-precos",
    n: "02",
    title: "Preços, CPC, CPM e oCPC",
    desc: "Modelos de compra, recomendação de lance e leilão de segundo preço ponderado por relevância.",
  },
  {
    href: "/chatgpt-ads-metricas",
    n: "03",
    title: "Métricas e matemática de mídia",
    desc: "CTR, CPC, CPM, conversões, CVR, CPA, ROAS e como não confundir dashboard com resultado.",
  },
  {
    href: "/ads-manager-chatgpt",
    n: "04",
    title: "OpenAI Ads Manager Beta",
    desc: "Países disponíveis, recursos, reporting, CSV, permissões, chaves e limites do beta.",
  },
  {
    href: "/chatgpt-ads-privacidade",
    n: "05",
    title: "Privacidade em ChatGPT Ads",
    desc: "O que o sistema pode usar como contexto, o que o anunciante não recebe e como os controles funcionam.",
  },
];
        ...
        <section className="border-y border-border bg-muted/20">
          <div className="mx-auto max-w-7xl px-4 py-14 md:px-6 md:py-20">
            <div className="grid gap-10 lg:grid-cols-[0.34fr_0.66fr]">
              <div>
                <span className="font-mono text-xs font-bold uppercase tracking-[0.2em] text-primary">Topic cluster</span>
                <h2 className="mt-4 text-3xl font-black tracking-[-0.04em] md:text-4xl">Entre pela pergunta certa.</h2>
                <p className="mt-4 text-sm leading-6 text-muted-foreground">
                  Cada rota aprofunda uma intenção de busca sem duplicar o observatório inteiro.
                </p>
              </div>
              <div className="grid gap-3 sm:grid-cols-2">
                {deepDives.map((item) => (
                  <a key={item.href} href={item.href} className="group rounded-2xl border border-border bg-background p-5 transition hover:-translate-y-0.5 hover:border-primary/35 hover:shadow-md">
                    <div className="flex items-center justify-between">
                      <span className="font-mono text-xs font-bold text-primary">{item.n}</span>
