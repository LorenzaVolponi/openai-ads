  ...
  return (
    ...
    >
      ...
      <LegalSection title="2. Marcas e propriedade intelectual de terceiros">
        <p>
          “OpenAI”, “ChatGPT”, “GPT” e demais nomes, logotipos, produtos e marcas associados à OpenAI
          pertencem à OpenAI ou aos seus respectivos titulares. As referências neste guia são nominativas,
          contextuais e informativas. O projeto utiliza sua própria identidade visual volponi.tech e não
          pretende reproduzir, imitar ou incorporar a identidade visual da OpenAI como identidade própria.
        </p>
        <p>
      ...
      <LegalSection title="3. Natureza do conteúdo">
        <p>
      ...
      <LegalSection title="4. Produto em evolução">
        <p>
          Recursos, mercados, planos, formatos, ferramentas para anunciantes e políticas podem mudar sem
          que esta página seja atualizada imediatamente. Para uma decisão operacional, prevalecem a
          documentação oficial vigente, os termos aplicáveis e as funcionalidades efetivamente disponíveis
          na conta do usuário ou anunciante.
        </p>
      </LegalSection>

      <LegalSection title="5. Fontes e correções">
        <p>
          O guia prioriza fontes primárias e oficiais, data afirmações sensíveis ao tempo e evita tratar
          rumor, estimativa ou screenshot de terceiros como recurso confirmado. Erros factuais podem ser
      ...
      <LegalSection title="8. Uso do conteúdo">
        <p>
